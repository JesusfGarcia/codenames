...
public class Activity_profile extends AppCompatActivity implements ChangePasswordDialog.Listener {
    public static final String TAG = Activity_profile.class.getSimpleName();
